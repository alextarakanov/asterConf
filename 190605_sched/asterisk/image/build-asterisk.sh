...
#https://downloads.mysql.com/archives/get/file/mysql-connector-odbc-5.1.12-linux-debian6.0-x86-64bit.tar.gz
...
menuselect/menuselect --enable cdr_mysql app_mysql menuselect.makeopts
