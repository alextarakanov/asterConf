...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <hr>
            <?= $form->field($model, 'bNumberEnable')->dropDownList([
                '0' => 'отключить',
                '1' => 'включить',
        ...
        <div class="col-md-4 col-md-offset-2">
            ...
            <hr>
            <?= $form->field($model, 'smb_dev_disable')->dropDownList([
                'disable' => 'отключить',
                'enable' => 'включить',
                'none' => 'не изменять текущее состояние',
                ],
                [
                    'value' => 'none',
                ])->label('отключить SIM слоты на SMB сервере') ?>
            <hr>
